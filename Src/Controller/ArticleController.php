...
class ArticleController
{
    ...
    public function getAllPermissionedArticle($condition1, $conditionCheck1, $condition2, $conditionCheck2, $category): array
    {
        ...
        if (isset($category)) {
            ...
            $result = $dbController->getAllByOr("article", $condition1, $conditionCheck1, $condition2,
                $conditionCheck2);
        }
    ...
    {
        return $this->getArticleInfo($articleId, "category_fsid", "name",
            "category");
    }
    ...
    {
        return $this->getArticleInfo($articleId, "visibility_fsid", "name",
            "visibility");
    }
